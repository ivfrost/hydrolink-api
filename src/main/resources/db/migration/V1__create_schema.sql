...
CREATE TABLE tokens (
                        ...
                        CONSTRAINT tokens_type_check CHECK (((type)::text = ANY ((ARRAY['RECOVERY_CODE'::character varying, 'AUTH_ACCESS_TOKEN'::character varying, 'AUTH_REFRESH_TOKEN'::character varying, 'MQTT_TOKEN'::character varying, 'DEVICE_MQTT_TOKEN'::character varying])::text[])))
);
